module game_hero::sea_hero {
    ...
    public entry fun attack(hero: &Hero, monster: SeaMonster, ctx: &mut TxContext) {
        let reward: Balance<VBI_TOKEN> = slay(hero, monster);
    ...
    public entry fun send_sea_monster(admin: &mut SeaHeroAdmin, reward_amount: u64, recipient: address, ctx: &mut TxContext) {
